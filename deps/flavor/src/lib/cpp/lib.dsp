...
ProjDir=.
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(ProjDir)\*.h ..\..\..\include	copy $(ProjDir)\Release\lib.lib ..\..\..\lib\CPP\flavor.lib
...
ProjDir=.
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(ProjDir)\*.h ..\..\..\include	copy $(ProjDir)\Debug\lib.lib ..\..\..\lib\CPP\flavor.lib
# End Special Build Tool
