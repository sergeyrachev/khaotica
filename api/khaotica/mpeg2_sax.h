...
namespace khaotica::syntax::mpeg2 {
    ...
    public:
        ...
        virtual void on(const uimsbfL_t&, const uimsbf_v&node, const uint64_t position, const uint64_t length) = 0;
        ...
        virtual void on(const collection_t& node, const collection_v& field, const uint64_t position, const uint64_t length, uimsbfL_tag) = 0;
        ...
        virtual void on(const sparsed_t& node, const sparsed_v& field, const uint64_t position, const uint64_t length, uimsbfL_tag) = 0;
        ...
        virtual void on(const slot_t& node, const slot_v& field, const uint64_t position, const uint64_t length, uimsbfL_tag) = 0;
